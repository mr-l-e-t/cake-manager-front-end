  ...
  return (
    <main className="page">
      ...
      <Suspense fallback={<p style={{ textAlign: 'center' }}>Loading...</p>}>
        <Await resolve={cake}>
          {(loadedCake) => <CakeDetail cake={loadedCake} isDisplayIngredients />}
...
export async function loader({ params }) { //request action from pages such as edit or delete. to be used in such scenarios
